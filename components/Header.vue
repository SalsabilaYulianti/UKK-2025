  ...
  <nav class="navbar navbar-expand-lg">
      <div class="container-fluid row">
        <div class="col-lg-1 col-md-2 col-sm-3 col-3">
          ...
          <div class="col-lg-9 col-md-7 col-sm-8 col-8 text-light">
            <!-- <div class="col-lg-7"> -->
            ...
            <div class="col-2 d-flex gap-5">
              <div class="col-1">
                <a href="https://www.instagram.com/smkn4tsmofficial/?igsh=MTl0eWJnMjQ4OHE4ZA%3D%3D#"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
              ...
              <div class="col-1">
                <a href="https://www.youtube.com/@smkn4tasikmalayamediaoffic704">
              ...
              <div class="col-1">
                <a href="https://tiktok.com/@smkn4tasikmalaya?_t=8sa9hpsi7rr&_r=1">
